...
public class RoadTripWrapper {
            ...
            if (comparison == 0)
                ...
                if (comparison < 0) {
                    if (root.getLeftChild() == null) {
                        ...
                        recPut(root.getLeftChild(), newEntry);
                } else {
                    if (root.getRightChild() == null) {
                        ...
                        recPut(root.getRightChild(), newEntry);
                }
            }
        }
     ...
     * 
     * Hint: Use a Priority Queue (or a Heap), where the total cost is the priority
     * (or you
    ...
    public static int canTravelMinCost(String A, String B, Graph<String, City> G) {
        ...
        while (!pq.isEmpty()) {
            ...
            for (City c : G.getNeighbors(city)) {
                if (!visited.containsKey(c.getCityName()))
                    pq.insert(cost + c.getTollCost(), c.getCityName());
            }
        }
        return -1;
    }
